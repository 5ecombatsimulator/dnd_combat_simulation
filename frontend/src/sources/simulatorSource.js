...
const SimulatorSource = {
  ...
  createAction: (name, action_type, stat_bonus, damage_type, bonus_to_hit, bonus_to_damage, multi_attack, recharge_percentile, is_legendary, legendary_action_cost, dice) =>
    http(postUrls.createAction, 'POST', {name, action_type, stat_bonus, damage_type, bonus_to_hit, bonus_to_damage, multi_attack, recharge_percentile, is_legendary, legendary_action_cost, dice}),
}
